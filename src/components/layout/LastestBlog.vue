<template>
  <section id="blog" class="section-padding">
    ...
    <div class="container">
      ...
      <div class="row">
        <div
          class="col-lg-4 col-md-6 col-sm-12 col-xs-12 blog-item"
        ...
        >
          ...
          <div class="blog-item-wrapper wow fadeInLeft" data-wow-delay="0.3s">
            ...
            <div class="blog-item-text">
              ...
              <router-link :to="item.linkTo" class="btn btn-common btn-rm">Read More</router-link>
            </div>
          </div>
...
export default {
  ...
  data: function() {
    return {
      items: [
        {
          title: "Suspendisse dictum non velit",
          image: img1,
          description:
